      ...
      <div className="container mx-auto px-4 py-4">
        <div className="bg-white rounded-lg shadow-md p-5 md:p-6">
          ...
          <div className="space-y-4">
            <section>
              <h2 className="text-xl font-bold text-blue-800 mb-1">Purpose of Use</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-blue-800 mb-1">No Professional Guarantee</h2>
              <p>Career recommendations are AI-generated and informational. We do not guarantee job placement or academic success.</p>
            </section>
            
            <section>
              <h2 className="text-xl font-bold text-blue-800 mb-1">User Responsibility</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-blue-800 mb-1">Data Usage</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-blue-800 mb-1">Content Ownership</h2>
              <p>All platform content (text, graphics, AI logic) is owned by SahiRaah. You may not copy or redistribute without permission.</p>
            </section>
            
            <section>
              <h2 className="text-xl font-bold text-blue-800 mb-1">Modification and Updates</h2>
              <p>We may change these terms. Continued use means you agree to any updated terms.</p>
            </section>
            
            <section>
              <h2 className="text-xl font-bold text-blue-800 mb-1">Contact</h2>
