    ...
    try {
      ...
      if (data.user) {
        toast({
          ...
          description: "Welcome to SahiRaah!",
        });
        navigate("/dashboard");
      }
    } catch (error: any) {
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-3">
            <Button 
              ...
              disabled={isLoading}
            >
              <svg className="absolute left-3" xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 0 24 24" width="20">
            ...
            <Button 
              ...
              disabled={isLoading}
            >
              <svg className="absolute left-3 text-blue-600" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
